...
requiredFiles:
  ...
  - "4. Reporte de policía"
  - "5. Orden de protección (si aplica)"
  - "6. Expedientes judiciales (si los hay)"
  - "7. Fotografías de lesiones (si aplica)"
  - "8. Reporte médico o del hospital"
  - "9. Evaluación psicológica o carta de terapeuta"
  - "10. Declaración personal del solicitante describiendo el crimen"
  - "11. Cartas o pruebas de cooperación con la policía o fiscal"
  - "12. Suplemento B firmado por autoridad certificada"
  - "13. Pruebas de residencia en EE.UU. (recibos, cartas, documentos escolares, etc.)"
  - "14. Historial migratorio (entradas y salidas del país)"
  - "15. Copia de la I-94 (si la tiene)"
  - "16. Registros de detención por ICE o CBP (si aplica)"
  - "17. Órdenes de deportación previas (si las hay)"
  - "18. Notificaciones de comparecencia en corte de inmigración - NTA (si aplica)"
  - "19. Permisos de trabajo anteriores (si los tuvo)"
  - "20. Actas de nacimiento de hijos, cónyuge o familiares incluidos (si aplica)"
  - "21. Certificado de matrimonio (si se incluye al cónyuge)"
  - "22. Pruebas de relación familiar (fotos, cartas, evidencia de dependencia económica)"
  - "23. Suplemento A para cada beneficiario derivado (si aplica)"
---

Formulario para víctimas de crímenes (Visa U). Incluye información personal, documentos migratorios, preguntas de admisibilidad, antecedentes criminales, historial migratorio, preguntas de seguridad nacional e información de familiares.
